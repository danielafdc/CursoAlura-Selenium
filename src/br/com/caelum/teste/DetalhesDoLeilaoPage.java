...
public class DetalhesDoLeilaoPage {
	...
	public void lance(String usuario, double valor){
		...
		Select comboxUsuario = new Select(driver.findElement(By.name("lance.usuario.id")));
		
		comboxUsuario.selectByVisibleText(usuario);
	...
	public boolean existeLance(String usuario, double valor){
		...
		Boolean temUsuario = new WebDriverWait(driver,5)
